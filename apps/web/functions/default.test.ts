...
test.each(defaultUrls)('should inject metadata for valid collections', async (defaultUrl) => {
  ...
  expect(body).toContain(`<meta property="og:description" content="Swap crypto on Citrea, the Bitcoin L2"`)
  expect(body).toContain(`<meta name="description" content="Swap crypto on Citrea, the Bitcoin L2"`)
