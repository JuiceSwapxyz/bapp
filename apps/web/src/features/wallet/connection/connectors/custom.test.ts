...
// Passkey/embedded wallet functionality removed
...
// useSignInWithPasskey mock removed - functionality no longer exists
...
describe('custom connectors', () => {
  ...
  describe('useConnectCustomWalletsMap', () => {
    it('should return a map with custom connector functions', () => {
      ...
      // Embedded wallet connector removed
    })
    ...
    // Embedded wallet test removed - functionality no longer exists
    ...
    // Embedded wallet error test removed - functionality no longer exists
  })
  ...
  describe('applyCustomConnectorMeta', () => {
    ...
    // Embedded wallet meta test removed - functionality no longer exists
    ...
    // Test for both transformations removed - embedded wallet functionality no longer exists
  })
})
