export const COIN_SWAP_ABI = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bytes32', name: 'preimageHash', type: 'bytes32' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'bytes32', name: 'preimageHash', type: 'bytes32' }],
    name: 'Refund',
    type: 'event',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'bytes32[]', name: 'preimages', type: 'bytes32[]' },
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: 'preimageHash', type: 'bytes32' },
      { internalType: 'address payable', name: 'claimAddress', type: 'address' },
      { internalType: 'uint256', name: 'timelock', type: 'uint256' },
